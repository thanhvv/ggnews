...
* Shortcodes examples: [news] - [news number=2] - [news order=desc] - [news number=3 order=asc] - [news cat=1] - [news cat=1,2] - [news col=3] [news cat=1,2 limitwordtitle=4 limitwordcontent=5 formatdate=Y-m-d imgtype = full]
